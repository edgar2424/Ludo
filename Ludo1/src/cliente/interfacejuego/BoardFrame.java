...
import cliente.Client.ObserverGame;
import cliente.Client.Client;
...
//		System.out.println("Enviando a todos que comecei o juego");
//		Client.getInstance().sendMessage("Iniciei o juego");
	}
	...
	public void receivedPlay(String play) {
		System.out.println("Recibi una jugada de alguien: " + play);
	}
